...
### <span style="margin: 0px; padding: 0px; border: 0px; font-weight: inherit; font-style: inherit; font-family: Arial; vertical-align: baseline;">Regular Meetting Time: {Mon 9-11 pm} at {Zoom:https://illinois.zoom.us/j/3935113249?pwd=WmFONnFJUHlBVlYrdHFPbFlvYndHQT09}.</span>

Unless otherwise notified, our regular weekly meeting for Fall 2020 is Mon 9-11 pm via Zoom. If you would like to present in an upcoming meeting, please email dzhou21/lecheng4 [at] illinois [dot] edu or submit a pull request and add to the table!</span>
...
| Sept 21, 2020   | Shengyu Feng    |  Graph Contrastive Learning  | [GCC: Graph Contrastive Coding for Graph Neural Network Pre-Training](https://arxiv.org/abs/2006.09963)   |
